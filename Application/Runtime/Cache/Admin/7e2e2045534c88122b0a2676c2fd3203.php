...
<body>
    ...
    <div class="welinfo">
    <span><img src="/luoliwuxie/Public/admin/images/sun.png" alt="天气" /></span>
    <b><?php echo $admin_name;?>&nbsp;您好！欢迎使用信息管理系统</b>(admin@uimaker.com)
    </div>
    
    <div class="welinfo">
    <span><img src="/luoliwuxie/Public/admin/images/time.png" alt="时间" /></span>
    <i>您上次登录的时间：<?php echo date("Y-m-d H:i:s",$last_login_time);?></i> 

    <img src="/luoliwuxie/Public/admin/images/ip_adress.png" alt="IP" />
    ...
    <div class="welinfo">
    <span><img src="/luoliwuxie/Public/admin/images/dp.png" alt="提醒" /></span>
    <b>绘本统计</b>
    </div>
